...
Finally, the web pages on [R-forge](http://genoplotr.r-forge.r-project.org/)
...
website [https://blast.ncbi.nlm.nih.gov/Blast.cgi](here). From there, the 
